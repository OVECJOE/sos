  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-purple-400 focus-visible:ring-2 focus-visible:ring-purple-400/30 focus-visible:bg-black/80 focus-visible:shadow-lg focus-visible:scale-[1.03]",
        // Error state
